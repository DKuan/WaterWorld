...
def parse_args():
    ...
    parser.add_argument("--learning_start_step", type=int, default=7e4, help="learning start steps")
    ...
    parser.add_argument("--batch_size", type=int, default=800, help="number of episodes to optimize at the same time")
    parser.add_argument("--memory_size", type=int, default=5e5, help="number of data stored in the memory")
    parser.add_argument("--num_units_1", type=int, default=1024, help="number of units in the mlp")
    ...
    parser.add_argument("--episode4save_model", type=int, default=5000, help="the number of the episode for saving the model")
    parser.add_argument("--start_save_model", type=int, default=40000, help="the number of the episode for saving the model")
