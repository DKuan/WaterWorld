...
def parse_args():
    ...
    # environment
    parser.add_argument("--scenario_name", type=str, default="water_world", help="name of the scenario script")
    ...
    parser.add_argument("--var_discount", type=float, default=0.999998, help="learning frequency")
    ...
    parser.add_argument("--num_units_o_1", type=int, default=1024, help="number of units in the mlp")
    parser.add_argument("--num_units_o_2", type=int, default=256, help="number of units in the mlp")
    parser.add_argument("--num_units_a_1", type=int, default=32, help="number of units in the mlp")
    parser.add_argument("--num_units_c2", type=int, default=64, help="number of units in the mlp")
    ...
    parser.add_argument("--start_save_model", type=int, default=40000, help="saving the model")
